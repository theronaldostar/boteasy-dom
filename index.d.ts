...
export declare const request: (object: object) => Promise<any>;
export declare const copy: (string: string) => void;
...
export declare const match: (object: object, index: number|string, change?: number|string|boolean) => any;
